...
function setup() {
	...
	World.add(world, packageBody);
	 ...
	 leftbox = Bodies.rectangle(200,700,20,100, {isStatic: true})
	 World.add(world, leftbox);

	 rightbox = Bodies.rectangle(400,700,20,100, {isStatic: true})
	 World.add(world, rightbox);

	bottombox = Bodies.rectangle(300,750,200,20, {isStatic: true})
